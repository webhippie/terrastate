...
func init() {
	...
	viper.BindPFlag("access.username", rootCmd.PersistentFlags().Lookup("general-username"))
	...
	viper.BindPFlag("access.password", rootCmd.PersistentFlags().Lookup("general-password"))
}
