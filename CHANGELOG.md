...
* **deps:** update docker digests ([41e245f](https://github.com/webhippie/terrastate/commit/41e245f7be3848155a1ce5fb17137001e31405f3))
* **deps:** update docker digests ([b179177](https://github.com/webhippie/terrastate/commit/b17917758ec6eccc9fdaef666e3c0325568247ce))
* **deps:** update docker digests ([1a3ad13](https://github.com/webhippie/terrastate/commit/1a3ad13647fe6163736c05919ce273e6f8d1871a))
* **deps:** update docker digests ([#294](https://github.com/webhippie/terrastate/issues/294)) ([8effcad](https://github.com/webhippie/terrastate/commit/8effcad8d0f25c9060ce1971995050cfcba2f113))

### Dependencies

* **minor:** update alpine docker tag to v3.24 ([#291](https://github.com/webhippie/terrastate/issues/291)) ([f53e732](https://github.com/webhippie/terrastate/commit/f53e732a1c77d0ec915007d4c46994953879c0e7))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([b0e3660](https://github.com/webhippie/terrastate/commit/b0e3660470686812777b52e095206776e6d76875))
...
* **patch:** update golang docker tag to v1.26.3 ([#285](https://github.com/webhippie/terrastate/issues/285)) ([415d4e4](https://github.com/webhippie/terrastate/commit/415d4e4f683093e51fa4e54d825398c47caa764e))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([b237347](https://github.com/webhippie/terrastate/commit/b2373476b5f13bf9a4b14da95624cf57b0e4a753))
* **flake:** updated lockfile [skip ci] ([5326d81](https://github.com/webhippie/terrastate/commit/5326d81a70b58129203bd361eb5a1c1a60382352))
...
* **patch:** update golang docker tag to v1.26.2 ([#277](https://github.com/webhippie/terrastate/issues/277)) ([3923959](https://github.com/webhippie/terrastate/commit/39239594546fdb0f10d0ab53f18ec1a281aa1342))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([df38e6b](https://github.com/webhippie/terrastate/commit/df38e6bc28068416e78d7cc46095c0e51365b846))
* **flake:** updated lockfile [skip ci] ([44776c3](https://github.com/webhippie/terrastate/commit/44776c35fb81e92027bca40f149a25c05bd8346c))

## [2.5.0](https://github.com/webhippie/terrastate/compare/v2.4.1...v2.5.0) (2026-03-30)

### Dependencies

* **minor:** update module github.com/rs/zerolog to v1.35.0 ([#275](https://github.com/webhippie/terrastate/issues/275)) ([c470156](https://github.com/webhippie/terrastate/commit/c4701568b0ae3b5a9d18bb31246ec74c8cadd8f3))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([66cd8d2](https://github.com/webhippie/terrastate/commit/66cd8d2d88631431db1a8375d162b0106fa70aa7))
* **flake:** updated lockfile [skip ci] ([eff638b](https://github.com/webhippie/terrastate/commit/eff638b7ad96363398aac5b1ebae9e98c14c5f1b))
* **flake:** updated lockfile [skip ci] ([f318c12](https://github.com/webhippie/terrastate/commit/f318c12b9bc56d7fdfcea4cd89d7692f4ccdfe1d))

## [2.4.1](https://github.com/webhippie/terrastate/compare/v2.4.0...v2.4.1) (2026-03-09)

### Dependencies

* **patch:** update golang docker tag to v1.26.1 ([#269](https://github.com/webhippie/terrastate/issues/269)) ([7e628b0](https://github.com/webhippie/terrastate/commit/7e628b0109af76a51a503879e9b062c00e450998))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([7fe0b73](https://github.com/webhippie/terrastate/commit/7fe0b73e8e97a3194d779b2ab061127d36072263))
...
* **patch:** update module github.com/go-chi/chi/v5 to v5.2.4 ([#254](https://github.com/webhippie/terrastate/issues/254)) ([7dbfbbd](https://github.com/webhippie/terrastate/commit/7dbfbbd40be91b572deefe9aa4708031ecf11511))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([4355730](https://github.com/webhippie/terrastate/commit/435573016777f2c1bf80b5de777aaa2e17c43b71))
* **flake:** updated lockfile [skip ci] ([ada39e7](https://github.com/webhippie/terrastate/commit/ada39e72b97bc88c99141588834481db39bb0f4c))
* **flake:** updated lockfile [skip ci] ([dba7d95](https://github.com/webhippie/terrastate/commit/dba7d9598b00d21565d245ccd9b8f2a48afd6884))
* **flake:** updated lockfile [skip ci] ([3bab3b7](https://github.com/webhippie/terrastate/commit/3bab3b753ef936e11e1130658b388c59c91c15b1))
...
* **deps:** update golang:1.25.4-alpine3.21 docker digest to 3289aac ([#223](https://github.com/webhippie/terrastate/issues/223)) ([2b9a097](https://github.com/webhippie/terrastate/commit/2b9a0973d5caf77ac98021a6f44eeccfe3c424bc))
* **patch:** update golang docker tag to v1.25.4 ([#222](https://github.com/webhippie/terrastate/issues/222)) ([9931be5](https://github.com/webhippie/terrastate/commit/9931be5d984a84e0937c723061a31e1501bb757a))
* **patch:** update module github.com/golangci/golangci-lint/v2 to v2.6.1 ([#219](https://github.com/webhippie/terrastate/issues/219)) ([0f63685](https://github.com/webhippie/terrastate/commit/0f6368520e6d701ce421f3547198cde1fa9312e7))

## [2.2.0](https://github.com/webhippie/terrastate/compare/v2.1.2...v2.2.0) (2025-11-03)


### Features

* **minor:** update module github.com/golangci/golangci-lint/v2 to v2.6.0 ([#218](https://github.com/webhippie/terrastate/issues/218)) ([d75b9be](https://github.com/webhippie/terrastate/commit/d75b9be23646d919bdf99ffcdd24941b9da16cca))
...
* **deps:** update docker digests ([#204](https://github.com/webhippie/terrastate/issues/204)) ([76e8815](https://github.com/webhippie/terrastate/commit/76e8815712ac7050cc06393a60931e53cbf354b1))
* **deps:** update golang:1.25.2-alpine3.21 docker digest to 0134653 ([#206](https://github.com/webhippie/terrastate/issues/206)) ([7d2f32b](https://github.com/webhippie/terrastate/commit/7d2f32b81c0a461fef7986bd8f4275c90e1bd929))
* **deps:** update golang:1.25.2-alpine3.21 docker digest to 0ae17b3 ([#208](https://github.com/webhippie/terrastate/issues/208)) ([8ce84e7](https://github.com/webhippie/terrastate/commit/8ce84e729fc4e939962430a084cddc18e8cb959d))
* **deps:** update golang:1.25.2-alpine3.21 docker digest to 7300a8d ([#205](https://github.com/webhippie/terrastate/issues/205)) ([0336c6b](https://github.com/webhippie/terrastate/commit/0336c6b102b83ebbebef8da9458a672f06b44506))
* **patch:** update golang docker tag to v1.25.2 ([#203](https://github.com/webhippie/terrastate/issues/203)) ([d48b3ef](https://github.com/webhippie/terrastate/commit/d48b3ef81961ca39da7b5d218e804de3ec15ea00))
